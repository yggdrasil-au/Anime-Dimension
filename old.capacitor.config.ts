...
const PluginsConfig = {
    ...
    /*CapacitorSQLite: {
        ...
        iosKeychainPrefix: 'animedimension',
        iosBiometric: {
            biometricAuth: false,
...
const config: CapacitorConfig = {
     ...
     * @since 1.0.0
     */
    appId: 'au.yggdrasil.animedimension',
